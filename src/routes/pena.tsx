...
/**
 * Resumen de pedidos pendientes: cliente, matrícula, piezas e importe,
 * para revisarlos de un vistazo sin abrir cada pedido.
 */
function PendientesTabla({
  pedidos,
  onOpen,
}: {
    ...
    <section className="overflow-hidden rounded-2xl border border-border bg-surface">
      <div className="flex items-baseline justify-between gap-3 border-b border-border px-4 py-3">
        <h2 className="text-sm font-semibold">
          Pedidos pendientes <span className="text-muted-foreground">({pedidos.length})</span>
        </h2>
            ...
            {pedidos.map((p) => (
              ...
              >
                ...
                <td className="px-4 py-2.5">
                  ...
                  <div className="text-[11px] text-muted-foreground">{p.vehiculo || ""}</div>
                </td>
